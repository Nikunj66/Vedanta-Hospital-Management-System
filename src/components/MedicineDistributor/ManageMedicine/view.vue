  ...
  <div>
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">
          <a href=""><i class="fa fa-plus-circle"></i>Medicine</a>
        </li>
      </ol>
    </section>
    <br />
    <div class="row">
      <div class="col-sm-12">
        <div class="pull-right">
          <a
            href="/#/medicinedistributor/managemedicine/add"
            style="margin-left: -6%"
          ...
          <a
            href="/#/medicinedistributor/dashboard"
              ...
              <tbody>
                <tr v-for="(item, index) in items" :key="item._id">
                  ...
                  <td class="text-center">
                    <a
                      :href="
                        '/#/medicinedistributor/managemedicine/edit/' + item._id
                      "
                      class="btn btn-primary"
