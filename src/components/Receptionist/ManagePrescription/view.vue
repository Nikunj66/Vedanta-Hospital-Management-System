    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="pull-right">
          <a
            :href="'/#/receptionist/manageprescription/add/' + pid"
            style="margin-left: -6%"
          ...
          <a
            href="/#/receptionist/managepatient"
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="text-center">
                    <a
                      :href="
                        '/#/receptionist/manageprescription/edit/' +
                        pid +
                        '/' +
                        item._id
                      "
                  ...
                  <td class="text-center">
                    <a
                      :href="'/#/receptionist/manageappointment/' + item._id"
                      class="btn btn-primary"
                      v-if="index == 1"
                      ><i class="fa fa-plus"> </i
                    ></a>
