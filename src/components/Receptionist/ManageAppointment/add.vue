    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>
          <a
            :href="
              '/#/receptionist/manageprescription/' +
              this.$session.get('patient_id')
            "
            ><i class="fa fa-book"></i>Prescription</a
          >
        </li>
        <li>
          <a :href="'/#/receptionist/manageappointment/' + pid"
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="pull-right">
          ...
          <a
            :href="'/#/receptionist/manageappointment/' + pid"
    ...
    submitData() {
      if (this.date == "") {
        ...
        axios
          ...
          .then((res) => {
            console.log(res),
              this.$router.push("/receptionist/manageappointment/" + this.pid);
          })
