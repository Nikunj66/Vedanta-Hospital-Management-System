              ...
              <tbody>
                <tr v-for="(item, index) in items" :key="item._id">
                  ...
                  <td class="text-center">
                    <a
                      :href="'/#/managetreatment/edit/' + item._id"
                      class="btn btn-primary"
  ...
  methods: {
    ...
    async getData() {
      ...
      var response = await axios.get(
        "http://127.0.0.1:8000/api/treatment/list?page=" + currentpage,
        { headers: header }
      );
      return response;
    },
    status(id) {
      ...
      if (obj.is_active) {
        axios
          .post("http://127.0.0.1:8000/api/treatment/deactivate/" + id, id, {
            headers: header,
          })
          .then((res) => {
            console.log(res);
        ...
        axios
          .post("http://127.0.0.1:8000/api/treatment/activate/" + id, id, {
            headers: header,
          })
          .then((res) => {
            console.log(res);
    ...
    async deleteData() {
      ...
      var response = await axios.delete(
        "http://127.0.0.1:8000/api/treatment/delete",
        {
          data: {
            id: this.selected,
          },
