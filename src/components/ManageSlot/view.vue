  ...
  methods: {
    ...
    async getData() {
      ...
      var response = await axios.get(
        "http://127.0.0.1:8000/api/slot/list?page=" + currentpage,
        {
          headers: header,
        }
      );
    ...
    status(id) {
      ...
      if (obj.is_active) {
        axios
          .post("http://127.0.0.1:8000/api/slot/deactivate/" + id, id, {
            headers: header,
          })
          .then((res) => {
            console.log(res);
        ...
        axios
          .post("http://127.0.0.1:8000/api/slot/activate/" + id, id, {
            headers: header,
          })
          .then((res) => {
            console.log(res);
    ...
    async deleteData() {
      ...
      var response = await axios.delete(
        "http://127.0.0.1:8000/api/slot/delete",
        {
          data: {
            id: this.selected,
          },
